...
import argparse #arg condition

from torch.utils.data import ConcatDataset, DataLoader #Train/Val
import pytorch_lightning as pl 

from text_recognizer import util #download img
...
#inherit from pl.Light : simple code
class BaseDataModule(pl.LightningDataModule):
    """
    Base DataModule. To avoid writing same code.
    ...
    def __init__(self, args: argparse.Namespace = None) -> None:
        ...
        self.subsample_fraction = self.args.get("subsample_fraction", None) #added arg 
